...
import 'swiper/css';
import 'swiper/css/scrollbar'; // Импортируем стили для полосы прокрутки
...
const SwiperCardContainer: React.FC = () => {
  ...
  const scrollbarRef = useRef<SVGSVGElement>(null); // Ссылка на кастомный скроллбар
  ...
  return (
    <div>
      <div className={styles.customScrollbar_container} >
